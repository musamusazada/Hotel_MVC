        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    pageIntro = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: false),
                    pageImg = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    location = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    receptionPhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    shuffleServicePhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    restaurantPhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    isDeleted = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DefSettings", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    mainTitle = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    mainText = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    isDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_ServicePages_ServicePageid",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    roomSqr = table.Column<int>(type: "int", nullable: false),
